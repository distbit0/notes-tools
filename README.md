...
| `open_chatgpt_conversations_in_brave.mjs` | Incrementally writes active ChatGPT conversation URLs to a text file when Brave history does not show them as viewed since their latest assistant response; it does not launch Brave. |
