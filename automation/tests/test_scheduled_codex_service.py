...
NETWORK_READY_DROP_IN = (
    REPO_ROOT
    / "automation/systemd/scheduled-codex-skills@.service.d/10-network-ready.conf"
)
...
def test_scheduled_codex_jobs_wait_for_networkmanager_startup_and_connectivity() -> None:
